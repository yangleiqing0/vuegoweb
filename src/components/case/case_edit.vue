    ...
    <div style="margin: 20px;"></div>
      <el-form :label-position="labelPosition" label-width="150px" :model="Form" size="small" status-icon :rules="rules" ref="Form">
        ...
        <el-form-item label="请求方式" prop="method" :rules="lengthCheck(0,10)">
         ...
         <el-form-item label="注册变量" prop="register_variable">
          <el-input v-model="Form.register_variable" type="textarea" autosize=""></el-input>
        </el-form-item>
        ...
        <div class="el-col-8">
          <div v-show="sql_config">
            ...
            <el-form-item label="前置数据库注册变量" prop="old_sql_register_variable">
              <el-input v-model="Form.old_sql_register_variable"  type="textarea" autosize=""></el-input>
            </el-form-item>
            ...
            <el-form-item label="后置数据库注册变量" prop="new_sql_register_variable">
              <el-input v-model="Form.new_sql_register_variable"  type="textarea" autosize=""></el-input>
            </el-form-item>
      ...
      methods:{
          ...
          run_old_mysql(){
              this.test_run('mysql_run', {
                  ...
                  register_variable : this.Form.old_sql_register_variable
              }, this)
          },
          run_new_mysql(){
              this.test_run('mysql_run', {
                  ...
                  register_variable : this.Form.new_sql_register_variable
              }, this)
          },
          ...
          getParams(){//接收函数
              ...
              if (this.$route.params.id){
                  this.my_get_data(this.$route.params.id, 'case/detail', this)
